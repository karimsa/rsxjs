...
function isReadable(t, c, shouldPass) {
  ...
  t[method](
    typeof c.take,
    "function",
    `channel should${shouldPass ? "" : " not"} have a take() method`
  );
  t[method](
    typeof c.select,
    "function",
    `channel should${shouldPass ? "" : " not"} have a select() method`
  );
  t[method](
    typeof c[Symbol.asyncIterator],
    "function",
    `channel should${shouldPass ? "" : " not"} support async iterator protocol`
  );
}
...
function isWritable(t, c, shouldPass) {
  ...
  t[method](
    typeof c.put,
    "function",
    `channel should${shouldPass ? "" : " not"} have a put() method`
  );
}
